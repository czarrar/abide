Node: resample_o (utility)
==========================

 Hierarchy : wf_test2.resample_o
 Exec ID : resample_o
...
* new_fname : /data/Projects/ABIDE_Initiative/CPAC/abide/qc/test_montage/wf_test2/resample_o/MNI152_Edge_AllTissues_1mm.nii.gz

Runtime info
------------

* duration : 0.807749032974
* hostname : rocky
