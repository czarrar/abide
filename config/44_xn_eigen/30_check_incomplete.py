...
# let's get those subjects but in this exclude ones for which we don't
# have a functional standard image
all_subs = []
for strat,df in ccs_df.iteritems():
    all_subs += subjects[(df.eigenvector_binarize == 0) & (df.functional_preprocessed_mni == 1)]
...
for strat in strategies:
    ...
    sublist_file    = "../40_xinian/quick_pack_rest_1_%s.yml" % strat
