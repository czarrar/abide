...
odir="cluster_temp_files/gen_means"
mkdir ${odir}

func_files=$(cat func_files.list | grep "gsc0_lp01" | tr '\n' ' ')
...
for func_file in ${func_files}; do
    ...
    echo "#$ -j y" >> ${scriptfile}
    echo "#$ -o /data/Projects/ABIDE_Initiative/CPAC/abide/config/50_niak/cluster_temp_files/gen_means/out_${subject}_${strat}_session_1.log" >> ${scriptfile}
    echo "" >> ${scriptfile}
    echo "source ~/.bashrc" >> ${scriptfile}
    echo "cd /data/Projects/ABIDE_Initiative/CPAC/abide/config/50_niak" >> ${scriptfile}
    echo "./06_gen_mean.bash ${func_file}" >> ${scriptfile}
    echo "" >> ${scriptfile}
