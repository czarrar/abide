...
sink.dir <- "/home2/data/Projects/ABIDE_Initiative/Derivatives/NIAK/Eigen"
...
suffix <- "centrality_outputs_zscore/_mask_mask_niak_90percent_gm/_scan_run1/eigenvector_centrality_weighted_maths.nii.gz"
